...
# mapScheme		This function generically creates a series of maps of a single scheme displaying a user-defined test statistic.  The output is a file on disk. It either shows:
...
#	stat		name of statistic to plot (should match a column in stats)
...
# source('C:/ecology/Drive/Research/Iconic Species/Scripts - Non-stationarity/Function - Map Scheme with Statistics (Single Map).r')
...
if (!exists('gadm') gadm <- readOGR('C:/ecology/Political Geography/GADM/ver2pt8/WGS84', 'USA_adm1', verbose=FALSE)
